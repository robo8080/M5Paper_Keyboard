...
BLEキーボードにも対応しました。<br><br>
これは、M5Paper_FactoryTestのキーボードの処理を抜き出して改造したものです。<br>
ベースにしたオリジナルはこちら。<br>
...
* "keyboard_config.h"の"#define USE_BLE_KEYBOARD"のコメントを外してビルドします。<br><br>
![画像6](images/image6.png)<br><br>
* "M5Paper-Keyboard"とペアリングします。
* 半角/全角の切り替え方法(確認したもの)<br>
